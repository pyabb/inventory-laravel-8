                ...
                <div class="modal-content">
                      ...
                      <i class="material-icons">category</i>
                                        ...
                                        <div class="form-line">
                                            <select class="form-control select2" v-model="product.category"
                                                ...
                                                <option v-for="(value, index) in cat" :value="value.id">{{
                                                        value.name
                                                    }}
                                                </option>
                                            </select>
                    ...
                    <span class="input-group-addon">
                      <i class="material-icons">line_style</i>
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" placeholder="Detalles"
                    ...
                    <div class="modal-footer">
                        ...
                        <button @click="updateProduct(product.id)" type="button"
                                class="btn btn-success waves-effect">Actualizar
                        </button>
