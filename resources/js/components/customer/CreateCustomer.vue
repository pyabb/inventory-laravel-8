                ...
                <div class="modal-content">
                    ...
                    <span class="input-group-addon">
                      <i class="material-icons">phone</i>
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" placeholder="Teléfono"
                    ...
                    <span class="input-group-addon">
                      <i class="material-icons">map</i>
                                        ...
                                        <div class="form-line">
                                            <input type="text" class="form-control date" placeholder="Dirección"
                    ...
                    <div class="modal-footer">
                        <br>
                        <button @click="createCustomer" type="button" class="btn btn-success waves-effect">Guardar
                        </button>
...
export default {
    ...
    methods: {
        createCustomer() {
            axios.post(base_url + "customer", this.customer)
                .then(response => {
