            ...
            <div class="modal-dialog modal-sm" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h4 class="modal-title" id="defaultModalLabel">Actualizar cantidad de {{
                                product.product_name
                            }}- {{ product.chalan_no }}</h4>
                    </div>
                                    ...
                                    <div class="input-group">
                                        ...
                                        <div class="form-line">
                                            <input type="number" class="form-control date"
                                                   placeholder="Cantidad para actualizar" v-model="product.new_qty">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="modal-footer">
                        <br>
                        <button @click="updateproduct()" type="button" class="btn btn-success waves-effect">Actualizar
                        </button>
