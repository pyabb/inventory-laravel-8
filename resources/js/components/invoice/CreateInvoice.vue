    ...
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
        ...
        <div v-show="invoice_state" class="card">
            <div class="header" style="padding-bottom: 60px;">
                ...
                <h2 class="pull-right">
                    <a href @click.prevent="showInvoice"
                    ...
                    <div class="row">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    ...
                                    <span class="requiredField" v-if="(errors.hasOwnProperty('customer_type'))">{{
                                            (errors.hasOwnProperty('customer_type')) ? errors.customer_type[0] : ''
                                        }}</span>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6" v-if="invoice.customer_type == 1">
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <multiselect v-model="invoice.customer_id" deselect-label="" track-by="id"
                                                 label="customer_name"
                                                 open-direction="bottom" placeholder="Seleccionar cliente"
                                                 :options="customers" :allow-empty="false">
                                    </multiselect>
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    ...
                                    <span class="requiredField" v-if="(errors.hasOwnProperty('customer_name'))">{{
                                            (errors.hasOwnProperty('customer_name')) ? errors.customer_name[0] : ''
                                        }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    ...
                                    <span class="requiredField" v-if="(errors.hasOwnProperty('customer_email'))">{{
                                            (errors.hasOwnProperty('customer_email')) ? errors.customer_email[0] : ''
                                        }}</span>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    ...
                                    <span class="requiredField" v-if="(errors.hasOwnProperty('customer_phone'))">{{
                                            (errors.hasOwnProperty('customer_phone')) ? errors.customer_phone[0] : ''
                                        }}</span>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="input-group">
                                ...
                                <div class="form-line">
                                    <Datepicker v-model="invoice.invoice_date"
                                                :class="'form-control'"
                                                :format="'yyyy-MM-dd'"
                                    ></Datepicker>
                            ...
                            <table class="table table-bordered table-condensed" style="min-height: 200px;">
                                ...
                                <tr v-for="(vl, index) in invoice.product">
                                    ...
                                    <td>
                                        ...
                                        <multiselect v-model="invoice.product[index].category" deselect-label=""
                                                     track-by="id" label="name"
                                                     open-direction="bottom" placeholder="Selecciona categoría"
                                                     :options="categorys"
                                                     @update:modelValue="findProduct(index)"
                                        ></multiselect>
                                        <span v-if="errors['product.' + index + '.category']" class="requiredField">{{
                                                errors['product.' + index + '.category'][0]
                                            }}</span>
                                    </td>
                                    <td>
                                        <!-- <select
                                        ...
                                        <multiselect v-model="invoice.product[index].product_id"
                                                     deselect-label=""
                                                     track-by="id"
                                                     label="product_name" open-direction="bottom"
                                                     placeholder="Seleccionar producto"
                                                     :options="invoice.product[index].products"
                                                     @update:modelValue="findStock(index)"
                                                     :allow-empty="false"
                                        ></multiselect>
                                        <span v-if="errors['product.' + index + '.product_id']" class="requiredField">{{
                                                errors['product.' + index + '.product_id'][0]
                                            }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <span v-if="errors['product.' + index + '.quantity']" class="requiredField">{{
                                                errors['product.' + index + '.quantity'][0]
                                            }}</span>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        ...
                                        <span v-if="errors['product.' + index + '.discount']" class="requiredField">{{
                                                errors['product.' + index + '.discount'][0]
                                            }}</span>
                                    </td>
                                    <td>
                        ...
                        <div class="col-md-12" style="margin-top: 20px">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group focused">
                                    ...
                                    <input type="text" class="form-control" v-model="invoice.paid_amount"
                                           placeholder="Pay Now"
                            ...
                            <div class="form-group" v-if="invoice.payment_in === 'bank'">
                                ...
                                <div class="input-group focused">
                                    ...
                                    <textarea rows="1" class="form-control no-resize auto-growth"
                                              ...
                                              style="border-bottom: 1px solid #ccc;"></textarea>
                                </div>
                            </div>
                            <div class="form-group">
