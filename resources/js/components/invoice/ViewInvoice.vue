    ...
    <div class="wrap">
        <div class="body" style="position: relative;">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <select class="form-control  select2" data-live-serach="true" @change="getData(1)"
                            v-model="customer_id"
...
<!--                        <td>{{ value.sell_date | moment('LL') }}</td>-->
                        ...
                        <td>
                            <a @click.prevent="ViewPayment(value.id)" href="" data-toggle="modal"
                               data-target="#viewPayment"
                               class="btn bg-cyan btn-circle waves-effect waves-circle waves-float"><i
                                class="material-icons">remove_red_eye</i></a>
                        </td>
                        <td>
                            <a @click.prevent="CreatePayment(value.id)" href="" data-toggle="modal"
