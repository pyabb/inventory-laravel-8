                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-condensed">
                                ...
                                <tr v-for="(vl, index) in invoice.product">
                                    ...
                                    <td>
                                        <select class="form-control" v-model="invoice.product[index].product_id"
                                                @change="findStock(index)">
                                            <option value="">Select Product</option>

                                            <option v-for="pr in vl.products" :value="pr.id">{{
                                                    pr.product_name
                                                }}
                                            </option>
                                        </select>
        ...
        editData(id) {
            axios.get(base_url + 'invoice/' + id + '/edit')
                .then(response => {
                    ...
                    this.invoice.invoice_date = this.invoice.invoice_date
